...
# Master dictionary for Round 7 precise fixes based on USER IMAGES
fixes = {
    10155: ("Arc'teryx Bird Word Graphic T-Shirt Collection", "Arc'teryx", "tshirts"),
    10101: ("Burberry Check Lined Puffer Vest", "Burberry", "jackets"),
    10103: ("Rick Owens DRKSHDW Low-Top Sneakers", "Rick Owens", "shoes"),
    10278: ("Chrome Hearts Cross Mesh Long Sleeve Knit", "Chrome Hearts", "hoodies"),
    10333: ("Undercover 'Leda and the Swan' Graphic T-Shirt", "Undercover", "tshirts"),
    10128: ("Supreme Old English Logo Knit Sweater", "Supreme", "hoodies"),
}
