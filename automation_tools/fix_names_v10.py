...
# Master dictionary for Round 10 precise fixes based on NEW USER IMAGES
fixes = {
    10084: ("Nike Air Max Plus TN Collection", "Nike", "shoes"),
    10085: ("Nike Air Max Plus TN 'Obsidian'", "Nike", "shoes"),
    10033: ("Denim Genes Vintage Wash Denim Jacket & Jeans Set", "Other", "sets"),
}
...
def apply_fixes():
    ...
    for p in products:
        ...
        if pid in fixes:
            ...
            # Special fix for 10085 broken image
            if pid == 10085:
                # Set image to same as 10084 since 10085 folder is empty
                p['image'] = "p_images/prod_84/主图_001.jpg"
                p['images'] = ["p_images/prod_84/主图_001.jpg"]
    ...
    # Bump DB_VERSION
    new_version = 'v42_final_corrections'
    new_content = re.sub(
        r"const DB_VERSION = '.*?';", 
