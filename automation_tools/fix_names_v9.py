...
# Master dictionary for Round 9 precise fixes based on NEW USER IMAGES
fixes = {
    10102: ("Corteiz (CRTZRTW) Graphic Mesh Shorts Collection", "Corteiz", "pants"),
    10053: ("Denim Tears Cotton Wreath Hoodie & Sweatpants Collection", "Denim Tears", "sets"),
    10127: ("RealTree Pattern Camo Graphic Hoodie Collection", "Other", "hoodies"),
}
...
def apply_fixes():
    ...
    # Bump DB_VERSION
    new_version = 'v41_user_image_fix_v2'
    new_content = re.sub(
        r"const DB_VERSION = '.*?';", 
